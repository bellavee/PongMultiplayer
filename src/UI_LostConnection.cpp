...
UI_LostConnection::UI_LostConnection(float width, float height, std::function<void()> onBackToMenu)
...
void UI_LostConnection::draw(sf::RenderTarget& target, sf::RenderStates states) const
{
